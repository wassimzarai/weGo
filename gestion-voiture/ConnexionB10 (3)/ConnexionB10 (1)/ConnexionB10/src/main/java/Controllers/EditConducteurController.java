...
public class EditConducteurController {
    ...
    public void setConducteur(Conducteur conducteur) {
        ...
        if (conducteur != null) {
            disponibiliteField.setText(String.valueOf(conducteur.getDisponibilite()));  // Convert integer to string
    ...
    private void saveConducteur() {
        ...
        try {
            ...
            conducteur.setDisponibilite(disponibiliteInt);  // Use Integer value here
