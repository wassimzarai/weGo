...
public class AddConducteurController {
    ...
    public AddConducteurController() {
        conducteurService = new ConducteurService();  // Initialize the service
    }
    ...
    public void initialize() {
        ...
        try {
            List<Integer> idVoitures = conducteurService.getAllIdVoitures();
    ...
    private void saveConducteur() {
        ...
        try {
            ...
            Conducteur conducteur = new Conducteur(idVoiture, nbDays, dateDepart, dateArret);

            // Insert the conducteur into the database
            conducteurService.insert(conducteur);
