...
public class Conducteur {
    ...
    public Conducteur(Integer idVoiture, int disponibilite, LocalDate dateDepart, LocalDate dateArret) {
        this.id = new SimpleIntegerProperty();
    ...
    public Conducteur(int id, int idVoiture, String disponibilite, String marqueVoiture, String modeleVoiture, String typeVoiture, LocalDate dateDepart, LocalDate dateArret) {
