...
public class ListeAbonnementsController {
    ...
    private void setupTableColumns() {
        ...
        reservationCol.setCellValueFactory(cellData -> {
            Entites.Reservation reservation = cellData.getValue().getReservation();
            if (reservation != null) {
    ...
    public void ouvrirAjout() {
        try {
            ...
            URL resourceURL = findFxmlResource("/fxml/AjoutAbonnement.fxml");
            ...
            URL cssURL = findFxmlResource("/fxml/styles.css");
            if (cssURL != null) {
