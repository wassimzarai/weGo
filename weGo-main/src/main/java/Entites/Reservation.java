...
public class Reservation {
    ...
    private trajet1 trajet; // Le trajet associé à cette réservation
    ...
    public Reservation(String nomPassager, LocalDate dateReservation, String pointDepart, String pointArrivee, 
                      String statut, String typeTrajet, String commentaire, trajet1 trajet, Passager passager) {
        this.nomPassager = nomPassager;
        this.dateReservation = dateReservation;
        this.pointDepart = pointDepart;
        this.pointArrivee = pointArrivee;
    ...
    public void removeAbonnement(Abonnement abonnement) {
        if (abonnement != null && this.abonnements.contains(abonnement)) {
            ...
            if (this.equals(abonnement.getReservation())) {
                abonnement.setReservation((Reservation) null);
            }
        }
    }
    ...
    public trajet1 getTrajet() {
        return trajet;
    }

    public void setTrajet(trajet1 trajet) {
