...
public class MenuFactureController {
    ...
    public void ouvrirAjouterFacture(ActionEvent event) {
        ouvrirInterface(event, "/fxml/AjouterFacture.fxml", "Impossible de charger l'interface Ajouter Facture");
    }

    // Méthode pour ouvrir l'écran Afficher Facture
    public void ouvrirAfficherFacture(ActionEvent event) {
        ouvrirInterface(event, "/fxml/AfficherFacture.fxml", "Impossible de charger l'interface Afficher Facture");
    }

    // Méthode pour ouvrir l'écran Modifier Facture
    public void ouvrirModifierFacture(ActionEvent event) {
        ouvrirInterface(event, "/fxml/ModifierFacture.fxml", "Impossible de charger l'interface Modifier Facture");
    }

    // Méthode pour ouvrir l'écran Supprimer Facture
    public void ouvrirSupprimerFacture(ActionEvent event) {
        ouvrirInterface(event, "/fxml/SupprimerFacture.fxml", "Impossible de charger l'interface Supprimer Facture");
    }

    // Méthode pour revenir au menu principal (corrigée)
    public void revenirAuMenuPrincipal(ActionEvent event) {
        ouvrirInterface(event, "/fxml/MenuPrincipal.fxml", "Impossible de charger l'interface Menu Principal");
    }
