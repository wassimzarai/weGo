...
public class MenuPaiementController {
    ...
    public void ouvrirAjouter(ActionEvent event) {
        chargerInterface(event, "/fxml/AjouterPaiement.fxml", "Impossible de charger l'interface Ajouter Paiement");
    }

    // Méthode pour ouvrir l'écran Afficher Paiement
    public void ouvrirAfficher(ActionEvent event) {
        chargerInterface(event, "/fxml/AfficherPaiement.fxml", "Impossible de charger l'interface Afficher Paiement");
    }

    // Méthode pour ouvrir l'écran Modifier Paiement
    public void ouvrirModifier(ActionEvent event) {
        chargerInterface(event, "/fxml/ModifierPaiement.fxml", "Impossible de charger l'interface Modifier Paiement");
    }

    // Méthode pour ouvrir l'écran Supprimer Paiement
    public void ouvrirSupprimer(ActionEvent event) {
        chargerInterface(event, "/fxml/SupprimerPaiement.fxml", "Impossible de charger l'interface Supprimer Paiement");
    }

    // Méthode pour revenir au menu principal
    public void revenirAuMenu(ActionEvent event) {
        chargerInterface(event, "/fxml/MenuPrincipal.fxml", "Impossible de charger l'interface Menu Principal");
    }
