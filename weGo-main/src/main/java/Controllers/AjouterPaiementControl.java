...
public class AjouterPaiementControl {
        ...
        void btnajouter(ActionEvent event) {
                try {
                        if (txtidres.getText().isEmpty() || txtmontant.getText().isEmpty() ||
                        ...
                        Paiement p = new Paiement(
                                0, // L'ID est mis à 0 ou ignoré, il sera généré automatiquement
                        ...
                        afficherErreur("Veuillez entrer des valeurs valides pour l'ID de réservation et le Montant.");
                }
        }
        ...
        private void handleBackToMenu(ActionEvent event) {
                try {
                        ...
                        Scene menuScene = new Scene(FXMLLoader.load(getClass().getResource("/fxml/MenuPaiement.fxml")));
