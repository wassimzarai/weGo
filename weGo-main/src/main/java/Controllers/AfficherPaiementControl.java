...
public class AfficherPaiementControl {
    ...
    private void naviguerAjout() {
        chargerVue("/fxml/AjouterPaiement.fxml", "Ajouter Paiement");
    }
    ...
    private void handleBackToMenu() {
        ...
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/fxml/MenuPaiement.fxml")); // Remplace "/Menu.fxml" si ton menu a un autre nom
