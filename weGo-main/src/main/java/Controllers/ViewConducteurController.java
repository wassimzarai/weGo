...
public class ViewConducteurController {
    ...
    @FXML private TableView<Chauffeur> conducteurTable;
    @FXML private TableColumn<Chauffeur, Integer> idColumn;
    @FXML private TableColumn<Chauffeur, Integer> idVoitureColumn;
    @FXML private TableColumn<Chauffeur, String> dateDepartColumn;
    @FXML private TableColumn<Chauffeur, String> dateArretColumn;
    @FXML private TableColumn<Chauffeur, String> nbDaysColumn;
    @FXML private TableColumn<Chauffeur, Void> actionsColumn;
    ...
    public void initialize() {
        ...
        try {
            List<Chauffeur> conducteurs = chauffeurservice.getAll();
    ...
    private void handleUpdate(int index) {
        Chauffeur c = conducteurTable.getItems().get(index);
    ...
    private void handleDelete(int index) {
        Chauffeur c = conducteurTable.getItems().get(index);
        try {
            boolean ok = chauffeurservice.delete(c.getId());
            if (ok) {
