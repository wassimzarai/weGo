...
public class Trajet {
    ...
    private double prix;
    private boolean autoriseFumeur;
    private boolean autoriseAnimaux;
    private boolean autoriseGrossBagages;
    ...
    public Trajet(int id, String villeDepart, String villeArrivee, String pointDepart, String pointArrivee,
    ...
    public boolean isAutoriseFumeur() {
    ...
    public boolean isAutoriseAnimaux() {
    ...
    public boolean isAutoriseGrossBagages() {
