...
public class ListeReservationsController {
    ...
    public void ouvrirAbonnements(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ListeAbonnements.fxml"));
            Parent root = loader.load();
    ...
    public void ouvrirReservationAutomatique() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ReservationAutomatique.fxml"));
            Parent root = loader.load();
