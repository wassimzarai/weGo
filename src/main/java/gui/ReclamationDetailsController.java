...
public class ReclamationDetailsController {
    ...
    private void loadResponses() {
        ...
        if (reclamation.getReponses() != null && !reclamation.getReponses().isEmpty()) {
            reclamation.getReponses().forEach(reponse -> 
    ...
    private String formatResponse(Reponse reponse) {
        ...
        return username + " (" + date + "): " + reponse.getMessage();
    }
    ...
    public void handleSendResponse() {
        ...
        try {
            ...
            reponse.setMessage(newResponseField.getText());
            ...
            // Rafraîchir la réclamation pour obtenir la nouvelle réponse
            ...
            showAlert("Réponse envoyée avec succès !");
        } catch (Exception e) {
